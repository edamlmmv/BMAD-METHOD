...
- **[self-improvement-checkpoint.template.md](./self-improvement-checkpoint.template.md)** - Checkpoint template for operator-run BMAD self-improvement
- **[self-improvement-codex-prompt.md](./self-improvement-codex-prompt.md)** - Codex prompt for BMAD self-improvement runs
