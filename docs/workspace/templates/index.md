...
- [base-improvement-goal.md](./base-improvement-goal.md)
- [base-improvement-prompt.md](./base-improvement-prompt.md)
- [base-mutation-grant.template.json](./base-mutation-grant.template.json)
- [bmad-loop-checkpoint.example.md](./bmad-loop-checkpoint.example.md)
...
- [capability-request.codex-manual.example.json](./capability-request.codex-manual.example.json)
- [capability-request.context7-docs.example.json](./capability-request.context7-docs.example.json)
- [capability-request.docker-mcp-toolkit.example.json](./capability-request.docker-mcp-toolkit.example.json)
- [capability-request.git-mcp-local.example.json](./capability-request.git-mcp-local.example.json)
- [capability-request.git-worktree-review.example.json](./capability-request.git-worktree-review.example.json)
- [capability-request.graphify-repo-intake.example.json](./capability-request.graphify-repo-intake.example.json)
- [capability-request.google-calendar-mcp.example.json](./capability-request.google-calendar-mcp.example.json)
...
- [self-improvement-checkpoint.template.md](./self-improvement-checkpoint.template.md)
