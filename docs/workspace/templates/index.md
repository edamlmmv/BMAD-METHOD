...
- [capability-request.context7-google-apps-script.example.json](./capability-request.context7-google-apps-script.example.json)
- [capability-request.context7-webgl-fundamentals.example.json](./capability-request.context7-webgl-fundamentals.example.json)
...
- [context7-google-apps-script-operator-evidence.template.json](./context7-google-apps-script-operator-evidence.template.json)
- [context7-webgl-fundamentals-operator-evidence.template.json](./context7-webgl-fundamentals-operator-evidence.template.json)
