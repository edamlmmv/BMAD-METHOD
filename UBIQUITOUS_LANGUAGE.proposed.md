...
| --- | --- | --- | --- |
| **Why the BMad Method?** | bmad | concept | `bmad:concept:readme-md:why-the-bmad-method` / README.md:14 |
| **BMAD Workspace Architecture** | bmad | concept | `bmad:concept:docs-workspace-architecture-md:bmad-workspace-architecture` / docs/workspace/architecture.md:6 |
| **BMAD Workspace Capability Contract** | bmad | concept | `bmad:concept:docs-workspace-capability-contract-md:bmad-workspace-capability-contract` / docs/workspace/capability-contract.md:6 |
| **Skill Validator — Inference-Based** | bmad | concept | `bmad:concept:tools-skill-validator-md:skill-validator-inference-based` / tools/skill-validator.md:1 |
| **Ubiquitous Language** | bmad | concept | `bmad:concept:docs-workspace-reviews-question-10-final-spec-assembly-md:ubiquitous-language` / docs/workspace/reviews/question-10-final-spec-assembly.md:55 |
| **Package scripts** | bmad | concept | `bmad:concept:package-scripts` / package.json |
| **npm run validate:graphify-manifests** | bmad | command | `bmad:command:npm-validate-graphify-manifests` / package.json |
| **npm run validate:skills** | bmad | command | `bmad:command:npm-validate-skills` / package.json |
| **Advanced Configuration** | codex | concept | `codex:concept:graphify-sources-codex-config-advanced-md:advanced-configuration` / <https://developers.openai.com/codex/config-advanced> |
| **Configuration Reference** | codex | concept | `codex:concept:graphify-sources-codex-config-reference-md:configuration-reference` / <https://developers.openai.com/codex/config-reference> |
| **Profiles** | codex | concept | `codex:concept:graphify-sources-codex-config-advanced-md:profiles` / <https://developers.openai.com/codex/config-advanced> |
| **Project Config Files** | codex | concept | `codex:concept:graphify-sources-codex-config-advanced-md:project-config-files` / <https://developers.openai.com/codex/config-advanced> |
| **Hooks** | codex | concept | `codex:concept:graphify-sources-codex-config-advanced-md:hooks` / <https://developers.openai.com/codex/config-advanced> |
| **Agent Roles** | codex | concept | `codex:concept:graphify-sources-codex-config-advanced-md:agent-roles` / <https://developers.openai.com/codex/config-advanced> |
| **Approval Policies And Sandbox Modes** | codex | concept | `codex:concept:graphify-sources-codex-config-advanced-md:approval-policies-and-sandbox-modes` / <https://developers.openai.com/codex/config-advanced> |
| **Named Permission Profiles** | codex | concept | `codex:concept:graphify-sources-codex-config-advanced-md:named-permission-profiles` / <https://developers.openai.com/codex/config-advanced> |
| **Shell Environment Policy** | codex | concept | `codex:concept:graphify-sources-codex-config-advanced-md:shell-environment-policy` / <https://developers.openai.com/codex/config-advanced> |
| **MCP Servers** | codex | concept | `codex:concept:graphify-sources-codex-config-advanced-md:mcp-servers` / <https://developers.openai.com/codex/config-advanced> |
| **Observability And Telemetry** | codex | concept | `codex:concept:graphify-sources-codex-config-advanced-md:observability-and-telemetry` / <https://developers.openai.com/codex/config-advanced> |
| **Requirements TOML** | codex | concept | `codex:concept:graphify-sources-codex-config-reference-md:requirements-toml` / <https://developers.openai.com/codex/config-reference> |
| **Graphify Command Reference** | graphify | concept | `graphify:concept:graphify-sources-graphify-full-command-reference-md:graphify-command-reference` / <https://github.com/safishamsi/graphify#full-command-reference> |
| **Query And Navigation Commands** | graphify | concept | `graphify:concept:graphify-sources-graphify-full-command-reference-md:query-and-navigation-commands` / <https://github.com/safishamsi/graphify#full-command-reference> |
| **Agent Integration Commands** | graphify | concept | `graphify:concept:graphify-sources-graphify-full-command-reference-md:agent-integration-commands` / <https://github.com/safishamsi/graphify#full-command-reference> |
| **Hook And Watch Commands** | graphify | concept | `graphify:concept:graphify-sources-graphify-full-command-reference-md:hook-and-watch-commands` / <https://github.com/safishamsi/graphify#full-command-reference> |
| **Graphify Architecture** | graphify | concept | `graphify:concept:graphify-sources-graphify-architecture-md:graphify-architecture` / <https://github.com/safishamsi/graphify/blob/v7/ARCHITECTURE.md> |
| **MCP Stdio Server** | graphify | concept | `graphify:concept:graphify-sources-graphify-architecture-md:mcp-stdio-server` / <https://github.com/safishamsi/graphify/blob/v7/ARCHITECTURE.md> |
| **Graphify How It Works** | graphify | concept | `graphify:concept:graphify-sources-graphify-how-it-works-md:graphify-how-it-works` / <https://github.com/safishamsi/graphify/blob/v7/docs/how-it-works.md> |
| **Confidence Tagging** | graphify | concept | `graphify:concept:graphify-sources-graphify-how-it-works-md:confidence-tagging` / <https://github.com/safishamsi/graphify/blob/v7/docs/how-it-works.md> |
| **SHA256 Cache** | graphify | concept | `graphify:concept:graphify-sources-graphify-how-it-works-md:sha256-cache` / <https://github.com/safishamsi/graphify/blob/v7/docs/how-it-works.md> |
| **Graph Format** | graphify | concept | `graphify:concept:graphify-sources-graphify-how-it-works-md:graph-format` / <https://github.com/safishamsi/graphify/blob/v7/docs/how-it-works.md> |
