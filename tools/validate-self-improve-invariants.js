...
const REQUIRED_INVARIANTS = [
  {
    ...
    policyTerms: ['fresh non-main branch', 'current `HEAD`', 'base_ref', 'codex/self-improve-'],
  },
  ...
  { id: 'SI-AUTO-003', label: 'local conventional commits', policyTerms: ['local commits', 'Conventional Commits'] },
  {
    ...
    policyTerms: ['dirty', 'chore: preserve pre-automation worktree state', 'secret', 'huge generated artifact'],
  },
  { id: 'SI-AUTO-005', label: 'full gates', policyTerms: ['npm ci && npm run quality'] },
  {
    id: 'SI-AUTO-006',
